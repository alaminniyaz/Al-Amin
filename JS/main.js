...
const contactForm = document.getElementById('contact-form'),
      ...
      const sendEmail = (e) => {
        ...
        if (contactName.value === '' || contactEmail.value === '' || contactProject.value === '') {
          ...
          // Show message	
          contactMessage.textContent = 'write down all the correct information 📝'
        } else {
          // serviceID - templateID - #form - publicKey
          emailjs.sendForm('service_aslbax9', 'template_5ynbl3j', '#contact-form', '6Ny-5utGaISfvw4Ep').then(() => {
            // Show message and add color
            contactMessage.classList.add('color-blue')
            contactMessage.textContent = 'Thanks for Submit ✅'
...
const scrollUp = () => {
  ...
  // when the scroll is higher than 350 viewport height, add the show-scroll calss to the a tag with the scrollup
